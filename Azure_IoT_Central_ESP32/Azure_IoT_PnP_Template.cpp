...
#define SAMPLE_MODEL_PROPERTY_VALUE "ESP32 & BMP 280"
#define SAMPLE_VERSION_PROPERTY_VALUE "1.0.0"
#define SAMPLE_OS_NAME_PROPERTY_VALUE "FreeRTOS"
#define SAMPLE_ARCHITECTURE_PROPERTY_VALUE "ESP32 WROOM"
...
int azure_pnp_send_telemetry(azure_iot_t* azure_iot, Adafruit_BMP280 bmp280)
{
...
static float get_temperature(Adafruit_BMP280 bmp280) { return bmp280.readTemperature(); }
static float get_pressure(Adafruit_BMP280 bmp280) { return bmp280.readPressure() / 100; }
static float get_altitude(Adafruit_BMP280 bmp280) { return bmp280.readAltitude(1013.25); }
